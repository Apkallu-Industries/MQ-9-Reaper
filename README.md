...
Built on a **Su-25T (FC3) flight-model shell** for rock-solid avionics and weapon integration, and developed under the **Autonomous Drone Asset Pack (ADAP)** initiative by **Apkallu Industries**.
...
- **Development:** Apkallu Industries — Autonomous Drone Asset Pack.
