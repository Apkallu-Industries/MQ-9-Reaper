-- MQ-9 Reaper Aircraft Descriptor for Flyable Mod
-- Converted for Pilot/Operator Control with Su-25T CWS HUD and Optical Avionics
...
Reaper =  {
	...
	nose_gear_pos 				= {3.175, -0.171, 0}, -- nosegear coord
	main_gear_pos 				= {-0.031, 0.009, 1.95}, -- main gear coords
	...
	crew_members = 
	{
		[1] = 
		{
			...
			g_suit             = 50.0, -- UAV Remote Operator (immune to in-cockpit G-forces)
		},
	}, -- end of crew_members
	...
	SFM_Data =
	{
		...
		engine = 
		{
			...
			dpdh_m	=	1025, --  altitude coefficient for max thrust	https://jira.eagle.ru/browse/ASSETS-2532 reduced to be able fly at 15000m
	...
	Damage  = verbose_to_dmg_properties({
		...
		["NOSE_BOTTOM"]  		 = {critical_damage = 2  },	--segment
            ...
            [WOLALIGHT_NAVLIGHTS] = {
                ...
                lights = {
                    {-- Left Position Light (red)
                        typename = "Omni", connector = "BANO_1", pos_correction = {0.147, 0.147, 0.000},
                        color = {0.99, 0.11, 0.3}, argument = 190,
                    },
                    {-- Right Position Light (green)
                        typename = "Omni", connector = "BANO_2", pos_correction = {0.147, -0.147, 0.000},
                        color = {0, 0.894, 0.6}, argument = 191,
                    },
                },
            },
            [WOLALIGHT_STROBES] = {
                ...
                lights = {
                    {
                        ...
                        lights = {
                            {
                                typename = "Strobe", connector = "BANO_3", pos_correction = {0.000, 0.200, 0.000}, argument = 193,
                                proto = lamp_prototypes.MPS_1,
                            },
                            {
                                typename = "Strobe", connector = "BANO_4", pos_correction = {0.000, -0.200, 0.000}, argument = 194,
                                proto = lamp_prototypes.MPS_1,
                            },
                        },
                    },
